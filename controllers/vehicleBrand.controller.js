...
exports.createBrand = async (req, res) => {
    try {
        ...
        if (existingBrand) {
            return response.sendError(res, 400, 'Brand with this name already exists');
        }
...
exports.getAllBrands = async (req, res) => {
    try {
        ...
        response.sendSuccess(res, 200, 'Brands fetched successfully', { brands, count: brands.length });
    } catch (error) {
...
exports.updateBrand = async (req, res) => {
    try {
        ...
        brand.logbookCost = logbookCost !== undefined ? logbookCost : brand.logbookCost;
...
exports.deleteBrand = async (req, res) => {
    try {
        ...
        response.sendSuccess(res, 200, 'Brand deleted successfully');
    } catch (error) {
